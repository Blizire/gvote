...
good_tests.append(cmd('!!gvote how do we know?yes no maybe',
                        'how do we know ?', 
                        ['yes', 'no', 'maybe']))
# extra spaces
good_tests.append(cmd('!!gvote  are   we  blasting  ?    yes  no  maybe ',
                        'are we blasting ?',
                        ['yes', 'no', 'maybe']))
...
# no question marks
bad_tests.append(cmd('!!gvote how do we know yes no maybe',
                       None,
                       None))

# no options
bad_tests.append(cmd('!!gvote how do we know?',
                       None,
                       None))

# only question marks
bad_tests.append(cmd('!!gvote ? ? ?',
                       None,
                       None))
